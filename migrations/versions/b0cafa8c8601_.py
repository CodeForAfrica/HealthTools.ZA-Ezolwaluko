...
def upgrade():
    ...
    op.create_index(op.f('ix_initiates_timestamp'), 'initiates', ['timestamp'], unique=False)
    op.create_table('register_surgeons',
    sa.Column('id', sa.Integer(), autoincrement=True, nullable=False),
    sa.Column('name', sa.String(length=50), nullable=True),
    ...
    op.create_index(op.f('ix_register_surgeons_timestamp'), 'register_surgeons', ['timestamp'], unique=False)
    op.create_table('reportsurgeons',
    sa.Column('id', sa.Integer(), autoincrement=True, nullable=False),
    ...
    op.create_index(op.f('ix_reportsurgeons_timestamp'), 'reportsurgeons', ['timestamp'], unique=False)
...
def downgrade():
    ...
    op.drop_index(op.f('ix_register_surgeons_timestamp'), table_name='register_surgeons')
